...
static void init()
{
	...
	// Create battery TextLayer in top right corner with 3px padding from
	// right edge Width is sized to fit "100%" exactly
	...
	s_battery_layer = text_layer_create(
		GRect(battery_x, battery_y, battery_width, battery_height));
